...
const FR: Record<string, string> = {
  ...
  // Server down (data backend unavailable)
  'serverDown.title': 'Serveur de données injoignable',
  'serverDown.body': 'L\'app a besoin du serveur de données pour accéder à tes comptes et tes données. Lance la commande ci-dessous dans un terminal, puis clique sur Réessayer.',
  'serverDown.cta': 'Réessayer la connexion',
...
const EN: Record<string, string> = {
  ...
  // Server down (data backend unavailable)
  'serverDown.title': 'Data server unreachable',
  'serverDown.body': 'The app needs the data server to access your accounts and data. Run the command below in a terminal, then click Retry.',
  'serverDown.cta': 'Retry connection',
